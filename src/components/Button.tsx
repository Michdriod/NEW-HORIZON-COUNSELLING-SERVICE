...
const variants = {
  ...
  primary:
    "bg-ink text-white shadow-[0_14px_30px_-16px_rgba(12,27,51,0.9)] hover:bg-primary hover:shadow-[0_20px_40px_-16px_rgba(10,53,144,0.75)]",
  accent:
    "bg-highlight text-white shadow-[0_14px_30px_-16px_rgba(197,127,46,0.9)] hover:bg-highlight-light hover:shadow-[0_20px_40px_-16px_rgba(197,127,46,0.8)]",
  secondary:
  ...
  onDark:
    "bg-white text-ink hover:bg-highlight hover:text-white shadow-[0_16px_38px_-18px_rgba(0,0,0,0.8)]",
};
